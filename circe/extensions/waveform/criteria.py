...
class WaveformOccurrence(Criteria):
    ...
    occurrence_end_datetime: Optional[DateRange] = Field(
        default=None, validation_alias=AliasChoices("OccurrenceEndDatetime", "occurrenceEndDatetime"), serialization_alias="OccurrenceEndDatetime"
    )

    # Visit context
    visit_occurrence_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("VisitOccurrenceId", "visitOccurrenceId"), serialization_alias="VisitOccurrenceId"
    )
    visit_detail_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("VisitDetailId", "visitDetailId"), serialization_alias="VisitDetailId"
    )

    # File metadata
    num_of_files: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("NumOfFiles", "numOfFiles"), serialization_alias="NumOfFiles"
    )
...
class WaveformRegistry(Criteria):
    ...
    waveform_occurrence_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("WaveformOccurrenceId", "waveformOccurrenceId"), serialization_alias="WaveformOccurrenceId"
    )

    # File temporal bounds
    file_start_datetime: Optional[DateRange] = Field(
        default=None, validation_alias=AliasChoices("FileStartDatetime", "fileStartDatetime"), serialization_alias="FileStartDatetime"
    )
    file_end_datetime: Optional[DateRange] = Field(
        default=None, validation_alias=AliasChoices("FileEndDatetime", "fileEndDatetime"), serialization_alias="FileEndDatetime"
    )

    # File format
    file_extension_concept_id: Optional[list[Concept]] = Field(
        default=None, validation_alias=AliasChoices("FileExtensionConceptId", "fileExtensionConceptId"), serialization_alias="FileExtensionConceptId"
    )
...
class WaveformChannelMetadata(Criteria):
    ...
    waveform_registry_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("WaveformRegistryId", "waveformRegistryId"), serialization_alias="WaveformRegistryId"
    )

    # Channel identification
    channel_concept_id: Optional[list[Concept]] = Field(
        default=None, validation_alias=AliasChoices("ChannelConceptId", "channelConceptId"), serialization_alias="ChannelConceptId"
    )
    ...
    metadata_concept_id: Optional[list[Concept]] = Field(
        default=None, validation_alias=AliasChoices("MetadataConceptId", "metadataConceptId"), serialization_alias="MetadataConceptId"
    )
    metadata_source_value: Optional[TextFilter] = Field(
        default=None, validation_alias=AliasChoices("MetadataSourceValue", "metadataSourceValue"), serialization_alias="MetadataSourceValue"
    )

    # Metadata values (at least one must be populated)
    value_as_number: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("ValueAsNumber", "valueAsNumber"), serialization_alias="ValueAsNumber"
    )
    value_as_concept_id: Optional[list[Concept]] = Field(
        default=None, validation_alias=AliasChoices("ValueAsConceptId", "valueAsConceptId"), serialization_alias="ValueAsConceptId"
    )

    # Units for numeric values
    unit_concept_id: Optional[list[Concept]] = Field(
        default=None, validation_alias=AliasChoices("UnitConceptId", "unitConceptId"), serialization_alias="UnitConceptId"
    )

    # Device/procedure linkage
    device_exposure_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("DeviceExposureId", "deviceExposureId"), serialization_alias="DeviceExposureId"
    )
    procedure_occurrence_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("ProcedureOccurrenceId", "procedureOccurrenceId"), serialization_alias="ProcedureOccurrenceId"
    )
...
class WaveformFeature(Criteria):
    ...
    algorithm_concept_id: Optional[list[Concept]] = Field(
        default=None, validation_alias=AliasChoices("AlgorithmConceptId", "algorithmConceptId"), serialization_alias="AlgorithmConceptId"
    )
    algorithm_source_value: Optional[TextFilter] = Field(
        default=None, validation_alias=AliasChoices("AlgorithmSourceValue", "algorithmSourceValue"), serialization_alias="AlgorithmSourceValue"
    )

    # Temporal window for feature
    feature_start_timestamp: Optional[DateRange] = Field(
        default=None, validation_alias=AliasChoices("FeatureStartTimestamp", "featureStartTimestamp"), serialization_alias="FeatureStartTimestamp"
    )
    feature_end_timestamp: Optional[DateRange] = Field(
        default=None, validation_alias=AliasChoices("FeatureEndTimestamp", "featureEndTimestamp"), serialization_alias="FeatureEndTimestamp"
    )
    ...
    measurement_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("MeasurementId", "measurementId"), serialization_alias="MeasurementId"
    )
    observation_id: Optional[NumericRange] = Field(
        default=None, validation_alias=AliasChoices("ObservationId", "observationId"), serialization_alias="ObservationId"
    )
