...
def event_starts(before: int = 0, after: int = 0, index: str = "startDate") -> Interval:
    """
    ...
    """
    return Interval(start=before, end=after, index=index)


def event_ends(before: int = 0, after: int = 0, index: str = "endDate") -> Interval:
    """
...
def continuous_observation(prior_days: int = 0, post_days: int = 0) -> ObservationWindow:
    """
    ...
    """
    return ObservationWindow(prior_days=prior_days, post_days=post_days)
