...
"""
    ...
    def resolve_where_clauses(self, criteria: Specimen, options: Optional[BuilderOptions] = None) -> list[str]:
        ...
        if criteria.occurrence_start_date:
            date_clause = BuilderUtils.build_date_range_clause("C.specimen_date", criteria.occurrence_start_date)
            if date_clause:
        ...
        # age
        if criteria.age:
            where_clauses.append(BuilderUtils.build_numeric_range_clause("YEAR(C.specimen_date) - P.year_of_birth", criteria.age))
