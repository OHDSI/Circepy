...
"""
    ...
    def resolve_join_clauses(self, criteria: DrugEra, options: BuilderOptions | None = None) -> list[str]:
    ...
    def resolve_where_clauses(self, criteria: DrugEra, options: BuilderOptions | None = None) -> list[str]:
