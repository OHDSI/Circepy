...
class ConceptSetCriteriaCheck(BaseCriteriaCheck):
    ...
    def _check_criteria(
        ...
        Operations.match(criteria).is_a(ConditionEra).then(
            ...
            lambda c: Operations.match(c)
            .when(
                lambda co: co.codeset_id is None and co.condition_source_concept is None
            )
            .then(add_warning)
        ).is_a(
            Death
            ...
            lambda c: Operations.match(c)
            .when(
                lambda m: m.codeset_id is None and m.measurement_source_concept is None
            )
            .then(add_warning)
        ).is_a(
            Observation
            ...
            lambda c: Operations.match(c)
            .when(
                lambda o: o.codeset_id is None and o.observation_source_concept is None
            )
            .then(add_warning)
        ).is_a(
            ProcedureOccurrence
            ...
            lambda c: Operations.match(c)
            .when(
                lambda po: po.codeset_id is None and po.procedure_source_concept is None
            )
            .then(add_warning)
        ).is_a(
            Specimen
            ...
            lambda c: Operations.match(c)
            .when(
                lambda vd: vd.codeset_id is None
                and vd.visit_detail_source_concept is None
            )
            .then(add_warning)
        )
