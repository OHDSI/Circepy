        ...
        if isinstance(criteria, ConditionOccurrence):
            ...
            def check(c: "ConditionOccurrence") -> None:
                self._check_text(
                    ...
                    Constants.Attributes.STOP_REASON_ATTR,
                )
            ...
            def check(c: "DeviceExposure") -> None:
                self._check_text(
                    ...
                    Constants.Attributes.UNIQUE_DEVICE_ID_ATTR,
                )
            ...
            def check(c: "DrugExposure") -> None:
                ...
                self._check_text(
                    c.lot_number,
                    Constants.Criteria.DRUG_EXPOSURE,
                    Constants.Attributes.LOT_NUMBER_ATTR,
                )
            ...
            def check(c: "Observation") -> None:
                self._check_text(
                    ...
                    Constants.Attributes.VALUE_AS_STRING_ATTR,
                )
            ...
            def check(c: "Specimen") -> None:
                self._check_text(
                    ...
                    Constants.Attributes.SOURCE_ID_ATTR,
                )
