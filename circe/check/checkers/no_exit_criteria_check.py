...
class NoExitCriteriaCheck(BaseCheck):
    ...
    def _check(self, expression: "CohortExpression", reporter: WarningReporter) -> None:
        ...
        match_result.when(
            lambda e: (
                e.primary_criteria
                and e.primary_criteria.primary_limit
                and e.primary_criteria.primary_limit.type
                and e.primary_criteria.primary_limit.type.upper() == "ALL"
                and e.end_strategy is None
