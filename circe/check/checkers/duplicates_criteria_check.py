...
class DuplicatesCriteriaCheck(BaseCriteriaCheck):
    ...
    def _compare_criteria(self, c1: "Criteria", c2: "Criteria") -> bool:
        ...
        if isinstance(c1, ConditionEra):
            ...
            return (
                self._compare_objects(c1.period_start_date, c2.period_start_date)
            ...
            return (
                c1.payer_concept == c2.payer_concept
                and c1.payer_source_concept == c2.payer_source_concept
                and c1.plan_concept == c2.plan_concept
                and c1.plan_source_concept == c2.plan_source_concept
                and c1.sponsor_concept == c2.sponsor_concept
                and c1.sponsor_source_concept == c2.sponsor_source_concept
                and c1.stop_reason_concept == c2.stop_reason_concept
                and c1.stop_reason_source_concept == c2.stop_reason_source_concept
            )
