...
def _person_filters_from_criterion(criteria: Criteria) -> NormalizedPersonFilters:
    return NormalizedPersonFilters(
        ...
        gender_codeset_id=(
            ...
            if getattr(criteria, "gender_cs", None) and criteria.gender_cs.codeset_id is not None
            else None
        ),
        race_concept_ids=_concept_ids(getattr(criteria, "race", None)),
        race_codeset_id=(
            int(criteria.race_cs.codeset_id)
            if getattr(criteria, "race_cs", None) and criteria.race_cs.codeset_id is not None
            else None
        ),
        ...
        ethnicity_codeset_id=(
            ...
            if getattr(criteria, "ethnicity_cs", None) and criteria.ethnicity_cs.codeset_id is not None
            else None
        ),
    )
