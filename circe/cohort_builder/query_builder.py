...
class BaseQuery:
    ...
    def __init__(
        ...
        self._config = QueryConfig(domain=domain, concept_set_id=concept_set_id)
        self._parent = parent
    ...
    def apply_params(self, **kwargs) -> "BaseQuery":
        ...
        if "anytime_before" in kwargs and kwargs["anytime_before"]:
            ...
            self._config.time_window = TimeWindow(
                days_before=kwargs["before_event_end"], days_after=0, use_index_end=True
            )
        ...
        if "gender" in kwargs:
            self._config.gender_concepts = (
                kwargs["gender"] if isinstance(kwargs["gender"], list) else [kwargs["gender"]]
            )
...
class ConditionQuery(BaseQuery):
    ...
    def apply_params(self, **kwargs) -> "ConditionQuery":
        ...
        if "status" in kwargs:
            self._config.status_concepts = (
                kwargs["status"] if isinstance(kwargs["status"], list) else [kwargs["status"]]
            )
        if "type" in kwargs:
            self._config.condition_type_concepts = (
                kwargs["type"] if isinstance(kwargs["type"], list) else [kwargs["type"]]
            )
        return self
...
class DrugQuery(BaseQuery):
    ...
    def apply_params(self, **kwargs) -> "DrugQuery":
        ...
        if "type" in kwargs:
            self._config.drug_type_concepts = (
                kwargs["type"] if isinstance(kwargs["type"], list) else [kwargs["type"]]
            )
        ...
        if "route" in kwargs:
            self._config.drug_route_concepts = (
                kwargs["route"] if isinstance(kwargs["route"], list) else [kwargs["route"]]
            )
...
class MeasurementQuery(BaseQuery):
    ...
    def with_range_high_ratio(
        self, min_ratio: float, max_ratio: Optional[float] = None
    ) -> "MeasurementQuery":
    ...
    def apply_params(self, **kwargs) -> "MeasurementQuery":
        ...
        if "unit" in kwargs:
            self._config.unit_concepts = (
                kwargs["unit"] if isinstance(kwargs["unit"], list) else [kwargs["unit"]]
            )
        ...
        if "value_as_concept" in kwargs:
            self._config.value_as_concept_concepts = (
                kwargs["value_as_concept"]
                if isinstance(kwargs["value_as_concept"], list)
                else [kwargs["value_as_concept"]]
            )
        if "operator" in kwargs:
            self._config.measurement_operator_concepts = (
                kwargs["operator"] if isinstance(kwargs["operator"], list) else [kwargs["operator"]]
            )
        return self
...
class ProcedureQuery(BaseQuery):
    ...
    def apply_params(self, **kwargs) -> "ProcedureQuery":
        ...
        if "modifier" in kwargs:
            self._config.procedure_modifier_concepts = (
                kwargs["modifier"] if isinstance(kwargs["modifier"], list) else [kwargs["modifier"]]
            )
        if "type" in kwargs:
            self._config.procedure_type_concepts = (
                kwargs["type"] if isinstance(kwargs["type"], list) else [kwargs["type"]]
            )
        return self
...
class VisitQuery(BaseQuery):
    ...
    def apply_params(self, **kwargs) -> "VisitQuery":
        ...
        if "place_of_service" in kwargs:
            self._config.place_of_service_concepts = (
                kwargs["place_of_service"]
                if isinstance(kwargs["place_of_service"], list)
                else [kwargs["place_of_service"]]
            )
        return self
...
class ObservationQuery(BaseQuery):
    ...
    def apply_params(self, **kwargs) -> "ObservationQuery":
        ...
        if "qualifier" in kwargs:
            self._config.qualifier_concepts = (
                kwargs["qualifier"] if isinstance(kwargs["qualifier"], list) else [kwargs["qualifier"]]
            )
...
class CriteriaGroupBuilder:
    ...
    def require_condition(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            ConditionQuery(concept_set_id, parent=self, is_exclusion=False).apply_params(**kwargs)._finalize()
        )
    ...
    def require_drug_era(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            DrugEraQuery(concept_set_id, parent=self, is_exclusion=False).apply_params(**kwargs)._finalize()
        )

    def require_measurement(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            MeasurementQuery(concept_set_id, parent=self, is_exclusion=False)
            .apply_params(**kwargs)
            ._finalize()
        )
    ...
    def require_procedure(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            ProcedureQuery(concept_set_id, parent=self, is_exclusion=False).apply_params(**kwargs)._finalize()
        )
    ...
    def require_observation(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            ObservationQuery(concept_set_id, parent=self, is_exclusion=False)
            .apply_params(**kwargs)
            ._finalize()
        )
    ...
    def require_visit_detail(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            VisitDetailQuery(concept_set_id, parent=self, is_exclusion=False)
            .apply_params(**kwargs)
            ._finalize()
        )
    ...
    def require_device(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            DeviceExposureQuery(concept_set_id, parent=self, is_exclusion=False)
            .apply_params(**kwargs)
            ._finalize()
        )
    ...
    def require_specimen(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            SpecimenQuery(concept_set_id, parent=self, is_exclusion=False).apply_params(**kwargs)._finalize()
        )

    def require_condition_era(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            ConditionEraQuery(concept_set_id, parent=self, is_exclusion=False)
            .apply_params(**kwargs)
            ._finalize()
        )
    ...
    def require_payer_plan_period(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            PayerPlanPeriodQuery(concept_set_id, parent=self, is_exclusion=False)
            .apply_params(**kwargs)
            ._finalize()
        )
    ...
    def exclude_condition(self, concept_set_id: int, **kwargs) -> "CriteriaGroupBuilder":
        return (
            ConditionQuery(concept_set_id, parent=self, is_exclusion=True).apply_params(**kwargs)._finalize()
        )
