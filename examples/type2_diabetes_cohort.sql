...
(
  ...
  FROM my_cdm_schema.CONDITION_OCCURRENCE co
...
-- End Condition Occurrence Criteria
	...
	JOIN my_cdm_schema.observation_period OP on E.person_id = OP.person_id and E.start_date >=  OP.observation_period_start_date and E.start_date <= op.observation_period_end_date
  WHERE DATEADD(day,365,OP.OBSERVATION_PERIOD_START_DATE) <= E.START_DATE AND DATEADD(day,1,E.START_DATE) <= OP.OBSERVATION_PERIOD_END_DATE
) P
