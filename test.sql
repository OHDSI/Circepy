...
WHERE (C.value_as_number >= 101.0000 and C.value_as_number <= 450.0000) AND C.unit_concept_id in (8848,8961,9444,8816,44777588)
...
WHERE (C.value_as_number >= 0.0100 and C.value_as_number <= 1.4990) AND C.unit_concept_id in (9444,8848,8816,8961,44777588) AND (C.range_low >= 1.5000 and C.range_low <= 4.0000)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 10.0000 and C.value_as_number <= 1500.0000) AND C.unit_concept_id in (8784,8647)
-- End Measurement Criteria
...
FROM 
(
  SELECT o.person_id,o.observation_id,o.observation_concept_id,o.visit_occurrence_id,o.value_as_number,o.value_as_string,o.value_as_concept_id,o.unit_concept_id,o.observation_date as start_date,DATEADD(day,1,o.observation_date) as end_date 
...
WHERE (C.value_as_number >= 4.0000 and C.value_as_number <= 11.0000) AND C.unit_concept_id in (4121395,8713,8950)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 150.0000 and C.value_as_number <= 450.0000) AND C.unit_concept_id in (8848,8961,9444,8816,44777588)
-- End Measurement Criteria
