...
class TestDateAdjustmentParity:
    ...
    def test_drug_exposure_date_adjustment(self):
        ...
        assert (
            "DATEADD(day,2, COALESCE(de.drug_exposure_end_date, DATEADD(day,0,de.drug_exposure_start_date)))"
            in sql
            or "DATEADD(day,2, de.drug_exposure_end_date)" in sql
        )
    ...
    def test_condition_era_date_adjustment(self):
        ...
        self.db.con.execute(
            "INSERT INTO condition_era (person_id, condition_era_id, condition_concept_id, condition_era_start_date, condition_era_end_date, condition_occurrence_count) VALUES (1, 100, 10, '2020-01-01'::DATE, '2020-01-10'::DATE, 1)"
        )
