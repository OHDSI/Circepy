...
class TestComparisonsCoverage(unittest.TestCase):
    ...
    def test_start_is_greater_than_end_date_invalid(self):
        self.assertFalse(Comparisons.start_is_greater_than_end(DateRange(value="invalid", extent="2020-01-01")))
        self.assertFalse(Comparisons.start_is_greater_than_end(DateRange(value="2020-01-01", extent="invalid")))
    ...
    def test_start_is_greater_than_end_period_invalid(self):
        self.assertFalse(Comparisons.start_is_greater_than_end(Period(start_date="invalid", end_date="2020-01-01")))
        self.assertFalse(Comparisons.start_is_greater_than_end(Period(start_date="2020-01-01", end_date="invalid")))

    def test_start_is_greater_than_end_period_valid(self):
        self.assertTrue(Comparisons.start_is_greater_than_end(Period(start_date="2020-01-02", end_date="2020-01-01")))
        self.assertFalse(Comparisons.start_is_greater_than_end(Period(start_date="2020-01-01", end_date="2020-01-02")))
    ...
    def test_start_is_greater_than_end_date_valid(self):
        self.assertTrue(Comparisons.start_is_greater_than_end(DateRange(value="2020-01-02", extent="2020-01-01")))
        self.assertFalse(Comparisons.start_is_greater_than_end(DateRange(value="2020-01-01", extent="2020-01-02")))
    ...
    def test_compare_to_calculation(self):
        ...
        # range2_diff = 5 - (-5) = 10
        w = Window(
            start=WindowBound(coeff=-1, days=5),
    ...
    def test_is_before_true(self):
        ...
        w = Window(
            start=WindowBound(coeff=-1, days=1),
    ...
    def test_compare_concept_set(self):
        ...
        c3 = Concept(concept_code="B", domain_id="D", vocabulary_id="V", concept_id=2, concept_name="N2", standard_concept="S", invalid_reason="I", concept_class_id="C")
    ...
    def test_compare_criteria_all_types(self):
        ...
        for cls in types:
            ...
            self.assertFalse(Comparisons.compare_criteria(c1, c3), f"Failed for {cls.__name__} mismatch")
