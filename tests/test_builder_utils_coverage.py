...
class TestBuilderUtilsDateRanges:
    ...
    def test_date_range_between(self):
        ...
        assert (
            clause
            == "(start_date >= DATEFROMPARTS(2020, 1, 1) and start_date <= DATEFROMPARTS(2020, 12, 31))"
        )
    ...
    def test_date_range_not_between(self):
        ...
        assert (
            clause
            == "not (start_date >= DATEFROMPARTS(2020, 1, 1) and start_date <= DATEFROMPARTS(2020, 12, 31))"
        )
