...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (435227,4181204,35622258,4101286,4177084))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (435227,4181204,35622258,4101286,4177084))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4030264,4295651,4043444,4057594,37016161,4056992,4043445,4323972,36402787,432571,4161665,4041104,36402625,4156433,4241295,4219140,317510,4215820,4224628,4347562,4161138,4058706,37206728,37204530,45767656,4264693,4043713,4301780,4301659,4221907,437233,4131124,36402821,4161560,37110403,4161020,4164159,4182216))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (432881,4131124,4182216))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (432881,4131124,4182216))
...
JOIN #Codesets cs on (o.observation_concept_id = cs.concept_id and cs.codeset_id = 23)
) C
...
(
  select o.person_id,o.observation_id,o.observation_concept_id,o.visit_occurrence_id,o.value_as_number,o.observation_date as start_date, DATEADD(day,1,o.observation_date) as end_date 
  FROM @cdm_database_schema.OBSERVATION o
JOIN #Codesets cs on (o.observation_concept_id = cs.concept_id and cs.codeset_id = 24)
) C
