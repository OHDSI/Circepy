...
1. condition occurrences of 'Alzheimer Disease '; with any of the following criteria:
...
2. condition occurrences of 'Dementia'; having at least 2 drug exposures of 'Prescription for an Alzheimers disease drug', starting between 0 days before and all days after 'Dementia' start date.

3. drug exposures of 'Prescription for an Alzheimers disease drug'; having at least 1 condition occurrence of 'Alzheimer Disease ', starting between 0 days before and all days after 'Prescription for an Alzheimers disease drug' start date.
