...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4230543))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4230543))
...
AND C.unit_concept_id in (4121396,8840,9028)
...
WHERE C.value_as_number > 17.0000
AND C.unit_concept_id in (3194935,8749)
-- End Measurement Criteria
