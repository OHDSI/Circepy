...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (435510,380534))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (435510,380534))

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4239780,4150930))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4239780,4150930))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (3006906,4216722,3032503))

) I
) C UNION ALL 
SELECT 2 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (3036426,3027694))

) I
) C UNION ALL 
SELECT 3 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (3021119,3021347))
...
WHERE (C.value_as_number >= 1.0000 and C.value_as_number <= 8.5000)
...
WHERE (C.value_as_number >= 1.0000 and C.value_as_number <= 4.5000)
AND C.unit_concept_id in (8840)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 8.5000 and C.value_as_number <= 30.0000)
AND C.unit_concept_id in (8840)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 4.6000 and C.value_as_number <= 20.0000)
AND C.unit_concept_id in (8840)
-- End Measurement Criteria
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,1,P.START_DATE) AND A.START_DATE <= DATEADD(day,30,P.START_DATE) ) cc 
...
WHERE (C.value_as_number >= 1.0000 and C.value_as_number <= 4.6000)
AND C.unit_concept_id in (8840)
-- End Measurement Criteria
