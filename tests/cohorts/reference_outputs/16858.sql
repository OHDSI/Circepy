...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (45768812,40478891))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (45768812,40478891))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (2617401,42738338,2213588,45768812,42738679,2213595,2213587,2617395,2617396,2617397,2213596,2213594,2617405,42738339,44782728,2213597,2213593,192279,2213589,197921,46271022,42738678,44786436,40660436,443919))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (2617401,42738338,2213588,45768812,42738679,2213595,2213587,2617395,2617396,2617397,2213596,2213594,2617405,42738339,44782728,2213597,2213593,192279,2213589,197921,46271022,42738678,44786436,40660436,443919))

) I
) C UNION ALL 
SELECT 3 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (40480067,37054839,37029074,4153000,37050168,1618096,37056925,37072252))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (40480067,37054839,37029074,4153000,37050168,1618096,37056925,37072252))
...
WHERE C.value_as_concept_id in (4083207)
...
WHERE (C.value_as_number >= 1.0000 and C.value_as_number <= 7.4000)
AND C.unit_concept_id in (4121402,8753)
-- End Measurement Criteria
...
WHERE (C.value_as_number >= 1.0000 and C.value_as_number <= 12.0000)
AND C.unit_concept_id in (4121395,8713)
-- End Measurement Criteria
