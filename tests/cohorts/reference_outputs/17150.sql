...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (3037678,4217034))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4189531,4059452,37018346,37018350,37018354,37018347,37018355,37018352,37018349,37018348,37018351,37018353,36674698,4128064,4125958,4056462,4128061,4263367,3184561,433257,195289,195314,42597049))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
...
FROM
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4059452))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (192279,192359,193253,194385,195314,195834,201313,261071,444044,4128219,4263367,46271022,4177206,37399017,36716270))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (192279,192359,194385,195314,195834,201313,261071,444044,4128219,4263367,46271022,4177206,37399017,36716270))

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (197930,43530912,4066005,37116834,195014,195289,45769152,193782,443611))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (197930,43530912,4066005,37116834,195014,195289,45769152,193782,443611))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (42733186,4032243,42733185,4206254,313232,4019967,2617462,2108276,4197217,2108277,438624,710018,44786436,2313999,4300839,44782924,4026915,40483083,2108302,4214705,42733188,38003418,43021985,2108035,46270032,4289454,710017,2617440,443212,38003417,4139362))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (42733186,4032243,42733185,4206254,313232,4019967,2617462,2108276,4197217,2108277,438624,710018,44786436,2313999,4300839,44782924,4026915,40483083,2108302,4214705,42733188,38003418,43021985,2108035,46270032,4289454,710017,2617440,443212,38003417))

) I
) C UNION ALL 
SELECT 6 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (437038))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4189531,4059452,37018349,37018353,37018347,37018355,37018351,37018348,37018352,37018346,37018354,37018350))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
...
) A on A.person_id = P.person_id  AND A.START_DATE >= DATEADD(day,-7,P.START_DATE) AND A.START_DATE <= DATEADD(day,-1,P.START_DATE) ) cc on p.person_id = cc.person_id and p.event_id = cc.event_id
...
select person_id, min(start_date) as start_date, DATEADD(day,-1 * 7, max(end_date)) as end_date
into #final_cohort
from (
  ...
  from (
    ...
    from (
      select person_id, start_date, DATEADD(day,7,end_date) as end_date
      from #cohort_rows
    ) CR
  ) ST
) GR
