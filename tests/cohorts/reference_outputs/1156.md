...
Entry events having no condition occurrences of 'Hemorrhagic stroke', starting in the 365 days prior to cohort entry start date; allow events outside observation period; having at least 1 visit occurrence of 'Inpatient or Inpatient/ER visit', starting anytime on or before 'Hemorrhagic stroke' start date and ending between 0 days before and all days after 'Hemorrhagic stroke' start date.
