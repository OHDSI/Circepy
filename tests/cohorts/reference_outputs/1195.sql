...
UNION  select c.concept_id
  ...
  and (ca.ancestor_concept_id in (312437,4305080))

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4059022,4059021,4190875,4263848,4318857))
