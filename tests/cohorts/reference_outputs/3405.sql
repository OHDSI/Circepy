...
from 
(
  select de.person_id,de.dose_era_id,de.drug_concept_id, de.unit_concept_id, de.dose_value,de.dose_era_start_date as start_date, de.dose_era_end_date as end_date 
