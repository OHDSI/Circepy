...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (320073,440689,4119158))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (320073,440689,4119158))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4100147))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4100147))
...
WHERE (C.value_as_number >= 1.5000 and C.value_as_number <= 30.0000)
...
WHERE (C.value_as_number >= 1500.0000 and C.value_as_number <= 30000.0000)
