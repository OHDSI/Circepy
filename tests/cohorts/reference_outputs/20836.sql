...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (441541,3661625,3661631,4093156,4104252,4189795,4294301,4294302,4317962,35622306,37162067,37162756,42536523))

) I
) C UNION ALL 
SELECT 1 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (3003215,3004327,3019198,3026710))

) I
) C UNION ALL 
SELECT 2 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4281826,132853))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4281826,132853))
...
WHERE (C.value_as_number >= 1.0000 and C.value_as_number <= 40.0000)
AND C.unit_concept_id in (9444,8848)
...
WHERE (C.value_as_number >= 1000.0000 and C.value_as_number <= 40000.0000)
AND C.unit_concept_id in (8784,8961)
-- End Measurement Criteria
