...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (43016394,2747030,2747032,2747034,2747036,2747038,43016392,43016398,43016393,2000811,2000834,2000810,2000833,2000832,2000835,2002768,2002751,2002764,2002750,2002763,2002762,2002765,2002769,2002766,2002770,2000836,2753386,2753378,2753379,2753380,2753381,43017217,2753176,2753177,2753368,2753369,2753374,2753375,2753376,2753377,43017215,2753370,2753371,2753372,2753373,2753398,2753399,2753400,2753401,43017218,2753390,2753391,2753392,2753393,43017216))
...
JOIN #Codesets cs on (po.procedure_concept_id = cs.concept_id and cs.codeset_id = 83)
) C
...
(
  select po.person_id,po.procedure_occurrence_id,po.procedure_concept_id,po.visit_occurrence_id,po.quantity,po.procedure_date as start_date, DATEADD(day,1,po.procedure_date) as end_date 
  FROM @cdm_database_schema.PROCEDURE_OCCURRENCE po
JOIN #Codesets cns on (po.procedure_source_concept_id = cns.concept_id and cns.codeset_id = 83)
) C
