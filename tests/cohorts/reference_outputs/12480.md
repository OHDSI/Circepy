...
1. condition occurrences of '[SOS] End-stage renal disease'.

2. procedure occurrences of '[SOS] End-stage renal disease'.

3. observations of '[SOS] End-stage renal disease'.
