...
UNION  select c.concept_id
  ...
  and (ca.ancestor_concept_id in (4002356,138379))

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4038845,4173974,4001331,4079683,44783718))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4038845,4173974,4001331,4079683,44783718))
