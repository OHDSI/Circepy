...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4214376,40480068,45763914,4129517,4308509))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (40480068,45763914,4129517,4308509))
...
WHERE (C.value_as_number >= 1.0000 and C.value_as_number <= 124.0000)
