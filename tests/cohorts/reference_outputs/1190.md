...
1. drug exposures of 'HORMONAL CONTRACEPTIVES FOR SYSTEMIC USE
'.

### Cohort Exit

The cohort end date will be based on a continuous exposure to 'HORMONAL CONTRACEPTIVES FOR SYSTEMIC USE
':
