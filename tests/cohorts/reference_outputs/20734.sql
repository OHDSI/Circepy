...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (317302))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (317302))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4030875,37520719,4051938,4087901,4019140,2313948,4048694,4152132,2313933,4078453,40756943,40756840,40757045,40756830,40756983,40756942,2001972,2001571,44816473,2313863,40488431,2313938,4019139,42872818,4018843,4049403,45890427,2313932,4203562,4070936,2107022,2107011,2726087,2726059,2726070,2726081,4270363,4242529,4296792,46257599,4050575,42894758,42894759,42894763,45890119,45890574,45889025,46257587,45890575,46257509,45889388,4050710,4315013,46257395,2107005,44816475,4044395,2755343,2755317,2755330,4300181,2001980,927085))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4030875,37520719,4051938,4087901,4019140,2313948,4048694,4152132,2313933,4078453,40756943,40756840,40757045,40756830,40756983,40756942,2001972,2001571,44816473,2313863,40488431,2313938,4019139,42872818,4018843,4049403,45890427,2313932,4203562,4070936,2107022,2107011,2726087,2726059,2726070,2726081,4270363,4242529,4296792,46257599,4050575,42894758,42894759,42894763,45890119,45890574,45889025,46257587,45890575,46257509,45889388,4050710,4315013,46257395,2107005,44816475,4044395,2755343,2755317,2755330,4300181,2001980,927085))

) I
) C UNION ALL 
SELECT 5 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (914335))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (914335))

) I
) C UNION ALL 
SELECT 6 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (321042,4223938,135360,4092013,444070,4223659,4169095,4272240,443240,4012520,77670,4181680))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (321042,4223938,135360,4092013,444070,4223659,4169095,4272240,443240,4012520,77670,4181680))

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4248028))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4248028))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4090698,45890027,45889522,4163951,45888788,4230911))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4090698,45890027,45889522,4163951,45888788,4230911))
...
) A on A.person_id = P.person_id  AND A.START_DATE >= P.OP_START_DATE AND A.START_DATE <= P.OP_END_DATE AND A.START_DATE >= DATEADD(day,0,P.START_DATE) AND A.START_DATE <= DATEADD(day,60,P.START_DATE) ) cc 
GROUP BY cc.person_id, cc.event_id
HAVING COUNT(cc.event_id) >= 1
-- End Correlated Criteria
...
JOIN #Codesets cs on (de.device_concept_id = cs.concept_id and cs.codeset_id = 3)
) C
...
WHERE C.value_as_concept_id in (2106185)
-- End Observation Criteria
