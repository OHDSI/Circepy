...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4195770,4132809,42535177,4132810,72714,4218311))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4195770,4132809,42535177,4132810,72714,4218311))
...
AND YEAR(C.start_date) - P.year_of_birth <= 16
AND C.ordinal = 1
