...
1. procedure occurrences of 'Lower Extremity Bypass (Bucher et al)'.

2. procedure occurrences of any procedure (including 'Lower Extremity Bypass (Bucher et al)' source concepts).
