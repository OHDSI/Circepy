...
1. measurements of 'SARS-CoV-2 test', starting after December 1, 2019; with value as concept: "negative", "not detected", "not detected in pooled specimen", "absent", "negative", "not detected" or "absent".
