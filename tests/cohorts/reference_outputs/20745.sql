...
UNION  select c.concept_id
  ...
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (44783621,4120094,715991,40493243,4119611,44783618,44783620,44783619,44782560,4013643,44783626,44783624,44782562,44783622,44783623,40482858,44783625,4121620,44782561,43020910,44782566,4207534,43021932,43020840,43020842,43021933,43020841,44783642,4120092))
...
WHERE C.value_as_concept_id in (4188164)
