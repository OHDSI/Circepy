...
1. condition occurrences of 'Respiratory failure concept'.

### Inclusion Criteria

#### 1. 365 washout period

Entry events having no condition occurrences of 'Respiratory failure concept', starting in the 365 days prior to cohort entry start date.
