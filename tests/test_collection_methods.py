...
def test_require_all_of():
    ...
    cohort = (
        CohortBuilder("Test ALL")
        .with_drug(1)
        .require_all_of(procedure_ids=[10, 11])
        .build()
    )
...
def test_exclude_any_of():
    ...
    cohort = (
        CohortBuilder("Test Exclusion")
        .with_condition(1)
        .exclude_any_of(drug_ids=[20, 21])
        .build()
    )
...
def test_collection_with_observation_ids():
    ...
    cohort = (
        CohortBuilder("Test Observations")
        .with_condition(1)
        .require_any_of(observation_ids=[5, 6, 7])
        .build()
    )
...
def test_collection_with_visit_ids():
    ...
    cohort = (
        CohortBuilder("Test Visits")
        .with_drug(1)
        .require_all_of(visit_ids=[100, 101])
        .build()
    )
