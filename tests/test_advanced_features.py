...
def test_during_event():
    ...
    cohort = (
        ...
        .require_measurement(10).during_event()
        .build()
    )
...
def test_before_event_end():
    ...
    cohort = (
        ...
        .require_drug(10).before_event_end(days=7)
        .build()
    )
...
def test_anytime_before_unlimited():
    ...
    cohort = (
        ...
        .require_condition(10).anytime_before()
        .build()
    )
...
def test_within_days_before_with_years():
    ...
    cohort = (
        ...
        .require_procedure(10).within_days_before(1825)  # 5 * 365
        .build()
    )
...
def test_within_days_after_with_years():
    ...
    cohort = (
        ...
        .require_death().within_days_after(365)  # 1 * 365
        .build()
    )
...
def test_with_distinct():
    ...
    criteria = cohort.inclusion_rules[0].expression.criteria_list[0]
    assert criteria.occurrence.is_distinct == True
...
def test_time_window_combinations():
    ...
    cohort = (
        ...
        .require_drug(10).within_days_before(730)  # 2 * 365
        .begin_rule("After Index")
        .require_procedure(20).anytime_after()
        .build()
    )
