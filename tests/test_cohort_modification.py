...
class TestCohortModification:
    ...
    def test_from_expression_with_new_title(self):
        ...
        expr = CohortBuilder("Original").with_drug(2).build()
    ...
    def test_from_expression_preserves_concept_sets(self):
        ...
        expr = CohortBuilder("Test").with_concept_sets(cs).with_condition(1).build()
    ...
    def test_modify_and_add_criteria(self):
        ...
        expr = CohortBuilder("Diabetes").with_condition(1).first_occurrence().build()
    ...
    def test_remove_inclusion_rule_invalid_name_raises(self):
        ...
        expr = CohortBuilder("Test").with_condition(1).build()

        with (
            pytest.raises(KeyError, match="No inclusion rule found"),
            CohortBuilder.from_expression(expr) as cohort,
        ):
    ...
    def test_remove_censoring_criteria_no_args_raises(self):
        ...
        with (
            pytest.raises(ValueError, match="Must provide one of"),
            CohortBuilder.from_expression(expr) as cohort,
        ):
    ...
    def test_remove_censoring_criteria_multiple_args_raises(self):
        ...
        with (
            pytest.raises(ValueError, match="Can only provide one of"),
            CohortBuilder.from_expression(expr) as cohort,
        ):
    ...
    def test_remove_entry_event_by_concept_set(self):
        ...
        expr = CohortBuilder("Test").with_condition(1).or_with_drug(2).build()
    ...
    def test_remove_last_entry_event_raises(self):
        ...
        with (
            pytest.raises(ValueError, match="Cannot remove the last entry event"),
            CohortBuilder.from_expression(expr) as cohort,
        ):
            cohort.remove_entry_event(concept_set_id=1)
    ...
    def test_remove_concept_set(self):
        ...
        expr = CohortBuilder("Test").with_concept_sets(cs1, cs2).with_condition(1).build()
    ...
    def test_remove_concept_set_invalid_id_raises(self):
        ...
        with (
            pytest.raises(KeyError, match="No concept set found"),
            CohortBuilder.from_expression(expr) as cohort,
        ):
    ...
    def test_modification_preserves_original(self):
        ...
        # Create original
        expr = CohortBuilder("Original").with_condition(1).require_drug(2, within_days_before=30).build()
