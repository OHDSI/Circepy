...
from circe.cohortdefinition.criteria import ConditionOccurrence, CorelatedCriteria, CriteriaGroup, Occurrence
...
class TestEvaluationMarkdownRender(unittest.TestCase):
    ...
    def test_render_complex_expression(self):
        ...
        corelated = CorelatedCriteria(
            criteria=m_criteria, occurrence=Occurrence(type=Occurrence._AT_LEAST, count=1)
        )
