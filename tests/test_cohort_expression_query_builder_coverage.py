...
class TestCohortExpressionQueryBuilderCoverage(unittest.TestCase):
    ...
    def test_limits_and_sorts(self):
        ...
        expression = CohortExpression(
            ...
            additional_criteria=CriteriaGroup(type="ALL", criteria_list=[]) # needed for qualified limit logic
        )
    ...
    def test_inclusion_rules_empty(self):
         ...
         self.assertNotIn("INTO #inclusion_rules", sql) # Should be skipped because rule_total == 0 check in _build_inclusion_analysis_section
