...
class TestPrimaryCriteria:
    ...
    def test_observation_window(self):
        ...
        primary = PrimaryCriteria(
            criteria_list=[ConditionOccurrence(codeset_id=1)], observation_window=obs_window
        )
        cohort = CohortExpression(primary_criteria=primary)
    ...
    def test_primary_limit_type(self):
        ...
        primary = PrimaryCriteria(criteria_list=[ConditionOccurrence(codeset_id=1)], primary_limit=limit)
        cohort = CohortExpression(primary_criteria=primary)
